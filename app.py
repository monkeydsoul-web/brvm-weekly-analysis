...
def api_price_history():
    """Historique de prix reel (price_history.json), sans point synthetique.
    PHBOC-1 : retrait des points boc dates du jour de lecture et du point invente du 1er janvier."""
    try:
        from price_history_builder import load_history
        history = load_history()
