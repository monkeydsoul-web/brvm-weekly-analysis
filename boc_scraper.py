...
"""
import requests, pdfplumber, io, json, os, re, logging, tempfile
    ...
    try:
        ...
        for chunk in r.iter_content(65536):
            ...
            if len(content) > 30 * 1024 * 1024:
                raise ValueError("PDF BOC trop volumineux (>30MB)")
        if content[:4] != b'%PDF':
            raise ValueError("Contenu recu n'est pas un PDF valide")
